...
<head>
    ...
    <meta name="keywords"
        content="{{ $product->name }}, wellness, health, skincare, organic products, natural remedies, Wellnez Mart">
    ...
    @if ($product->images->isNotEmpty())
        <meta property="og:image"
            content="{{ asset('public/products_uploads/' . $product->images->first()->image_path) }}">
    @endif
